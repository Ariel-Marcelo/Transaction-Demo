...
import com.demo.transactions.domain.dtos.cuenta.CuentaMapper;
import com.demo.transactions.domain.dtos.cuenta.CuentaRepositoryPort;
import com.demo.transactions.domain.dtos.cuenta.CuentaServicePort;
...
public class CuentaService implements CuentaServicePort {
    ...
    public CuentaResponse create(CuentaRequest cuentaRequest) {
        Cliente cliente = clienteRepository.getActiveClientById(cuentaRequest.getClienteId());
        ...
        if (savedCuenta.getSaldoInicial().compareTo(BigDecimal.ZERO) > 0) {
            ...
            movimientoInicial.setTipoMovimiento("Deposito");
